...
| -----: | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     0. | Rights            | All developed materials will be publicly accessible and public domain.                                                                                                                                                                                                                                                    |
|  **1** | Reasearch Goal    | We will provide an overview of the current state of the modern stablecoin ecosystem including a deep-dive into the largest stablecoins by volume.                                                                                                                                                                         |
| **1a** | Specific Coverage | Coverage curently planned is for: Angle Labs, Luna, Terra, DAI, Tether, USDC, BinanceUSD, Gemini Dollar, TrueUSD, Pax Dollar, NeutrinoUSD, Tribe, Frax, Liquidity USD, HUSD, XSGD, Reserve Rights, Origin dollar, Facebook's Diem, and Float. However we may add aditional coverage based on any findings in Milestone 1. |
...
| -----: | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     0. | Rights            | All developed materials will be publicly accessible and public domain.                                                                                                                                                 |
|  **1** | Reasearch Goal    | We will provide an analysis on failed stablecoins and the dynamics that lead to their downfall.                                                                                                                        |
| **1a** | Specific Coverage | Coverage curently planned is for: IRON which was tied to TITAN, Fei, Ampleforth, EmptySetDollar, DynamicSetDollar, BasisCash, NuBits. However we may add aditional coverage based on any findings in Milestone 1 or 2. |
...
| -----: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
|     0. | Rights                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | All developed materials will be publicly accessible and public domain. |
|  **1** | We will provide an overview of the current state of the modern stablecoin ecosystem including a deep-dive into the largest stablecoins by volume. (Specific coverage curently planned is for these coins: Angle Labs, Luna, Terra, DAI, Tether, USDC, BinanceUSD, Gemini Dollar, TrueUSD, Pax Dollar, NeutrinoUSD, Tribe, Frax, Liquidity USD, HUSD, XSGD, Reserve Rights, Origin dollar, Facebook's Diem, and Float. However we may add aditional coins based on any findings in Milestone 1) |
...
- Our long-term vision is to build an understanding of the stablecoin infrastructure enviorment and then develop and deploy the first derivative-backed stablecoin and launch it on the Polkadot Network.
