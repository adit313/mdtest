...
| **2a.** | Specifics                    | This Ink! Smart Contract will hold the pool of tokens in preperation for distribution. It will contain the function to either make divided payments when it is filled to capacity or to to have Bondcoin tokens redeemed for an equivalent % of the stored assets. pool. |
